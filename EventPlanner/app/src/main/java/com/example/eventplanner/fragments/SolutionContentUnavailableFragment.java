...
public class SolutionContentUnavailableFragment extends Fragment {

    public SolutionContentUnavailableFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_solution_content_unavailable, container, false);
