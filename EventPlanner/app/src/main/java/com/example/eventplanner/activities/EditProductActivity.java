...
public class EditProductActivity extends BaseActivity {
    ...
    private boolean validateInputs() {
        ...
        if (!validateField(location, errorProductLocation)) {
            isValid = false;
        }
    ...
    private void updateProduct() {
        ...
        RequestBody descriptionBody = RequestBody.create(MediaType.parse("text/plain"), productDescription.getText().toString());
        ...
        if (selectedLocationDetails != null) {
            ...
            locationBody = RequestBody.create(MediaType.parse("text/plain"), location.getText().toString());
